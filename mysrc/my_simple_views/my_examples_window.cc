...
ExampleVector CreateExamples() {
  ...
  examples.push_back(std::make_unique<views::mysrc::LabelExample>());
...
class ComboboxModelExampleList : public ui::ComboboxModel {
 public:
  ...
  int GetDefaultIndex() const override { return example_list_.size() - 1; }
